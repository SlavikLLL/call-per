    ...
    <div className="container mx-auto">
      <div className="flex flex-col xl:flex-row gap-x-8">
        ...
        <div className="text-center flex xl:w-[36vw] flex-col lg:text-left mb-4 xl:mb-0">
          <h2 className="text-2xl xl:mt-8"> <span className="text-accent">Умови</span> праці</h2>
          <p className="mb-4 text-md max-w-[400px] mx-auto lg:mx-0">
          ...
          <h2 className="text-2xl xl:mt-8"> <span className="text-accent">Заробітна </span>плата</h2>
          <p className="mb-4 text-md max-w-[400px] mx-auto lg:mx-0">
